...
def Randomflip(images):
    ...
    for X_batch, y_batch in randflip.flow(images,labels, batch_size=2000):
        break
...
def Rotation(images):
    ...
    for X_batch_rot2, y_batch_rot2 in datagen_Rotation2.flow(images,labels, batch_size=100):
        break
...
def Zca_Whitening(images):    
    ...
    for X_batch_zca, y_batch_zca in datagen_zca.flow(images,labels, batch_size=200):
        break
...
def Shift_Img(images):
    ...
    for X_batch_shift, y_batch_shift in datagen_shift.flow(images,labels , batch_size=200):
        break
